...
| トラック | いつ | 中身 |
| --- | --- | --- |
| **通常** | ふだん | やさしいチップチューン。8小節、Am-Em-F-C-Am-Em-F-E。138 BPM |
| **前兆** | ゲージ62%以上 | メロディを抜き、ライザーとタム回しで不安を積む。150 BPM |
| **ボーナス** | ボーナス中 | 16小節。180〜188 BPM |

ボーナス曲は16小節で起伏を作っています。

1. **A面（1〜7小節）** — 分散和音は8分、ハットは4分に間引いた薄い編成
2. **ブレイク（8小節）** — ドラムと分散和音を抜いて穴をあけ、メロディの駆け上がりと
   スネアロールだけ残す（A面比 −0.9 dB）
3. **B面（9〜16小節）** — 平行調のCに開けてメロディを1オクターブ上へ。分散和音は16分、
   ハットも16分、メロディをオクターブ重ね（A面比 **+2.2 dB**、ブレイクからは **+3.0 dB**）

メロディを上げるだけでは盛り上がりません。**編曲そのものを段階的に変える**必要があります。
